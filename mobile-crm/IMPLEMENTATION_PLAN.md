...
2. 진행 중: 업체별 암호화 자격 증명·채널·승인 템플릿 등록 API 및 Android 관리자 화면, 자동 발송 라우팅 구현.
3. 대기: 격리 QA로 회사별 분리·비밀값 비노출·SMS/알림톡 라우팅 검증 후 Worker 배포와 최종 Android 빌드.
4. 대기: 연결 휴대폰 설치·운영 로그인 유지·푸시 연결 확인 후 최종 APK 업무메일 전송.
