...
// Meta Lead Ads(페이스북/인스타그램) 접수 시 고객에게 발송할 LMS 본문.
// 홈페이지 본문과 한 줄(신청 채널 안내)만 다름. 주소/담당자/링크는 HOMEPAGE 와 동일하게 유지.
export const META_CUSTOMER_NOTICE = [
  "안녕하세요 고객님,",
  "[데이원디자인]입니다.",
  "",
  "페이스북/인스타그램을 통해 신청해주신",
  "인테리어 상담문의가 정상적으로",
  "접수되어 담당매니저가 배정되었습니다.",
  "",
  "담당매니저가 고객님께",
...
export const META_CUSTOMER_SUBJECT = "[데이원디자인] 상담 접수 확인";
